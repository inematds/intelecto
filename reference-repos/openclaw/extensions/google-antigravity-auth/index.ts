...
// NOTE: valores OAuth originais redigidos (referencia local — vendorizado no INTELECTO)
const CLIENT_ID = decode(
  "UkVEQUNURUQ=", // base64("REDACTED")
);
const CLIENT_SECRET = decode("UkVEQUNURUQ="); // base64("REDACTED")
